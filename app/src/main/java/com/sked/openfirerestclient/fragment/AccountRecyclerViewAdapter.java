...
import com.sked.openfirerestclient.fragment.dummy.DummyContent.Account;
...
public class AccountRecyclerViewAdapter extends RecyclerView.Adapter<AccountRecyclerViewAdapter.ViewHolder> {
    ...
    public AccountRecyclerViewAdapter(List<Account> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
